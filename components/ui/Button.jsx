...
export const variantStyles = {
  static1: "relative bg-blue-600 w-24 h-11 text-white hover:bg-blue-700 focus:ring-blue-500 rounded-full shadow-md shadow-blue-300",
  ...
  static3: "cursor-pointer w-24 h-12 flex items-center justify-center fill-lime-400 bg-lime-950 hover:bg-lime-900 active:border active:border-lime-400 rounded-md duration-100 p-2",
  static4: "bg-[#9333EA] text-black hover:bg-blue-400 focus:ring-blue-200 w-24 h-12 rounded-full shadow-lg shadow-[#9333EA]/30 transform active:translate-y-1 transition duration-300",
  ...
  Animated13: "cursor-pointer text-black uppercase bg-white px-4 py-2 active:translate-x-0.5 active:translate-y-0.5 hover:shadow-[0.5rem_0.5rem_#F44336,-0.5rem_-0.5rem_#00BCD4] transition",
  ...
  Animated15: "relative w-32 h-12 text-black p-0 border-none text-[15px] cursor-pointer rounded-[5px] bg-[#5cdb95] font-[Gochi Hand] transition-all duration-[300ms] ease-[cubic-bezier(0.175,_0.885,_0.32,_1.275)] transform shadow-[0_2px_0_#494a4b] active:translate-y-[5px] active:pb-0 flex items-center justify-center",
  ...
  Animated20: "cursor-pointer bg-gray-800 px-3 py-2 rounded-md text-white tracking-wider shadow-xl animate-bounce hover:animate-none hover:shadow-2xl hover:bg-gray-900 transition-all",
};
